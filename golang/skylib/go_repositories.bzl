...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:710u7Q1xpbzpigh/RPPUXwr/5X/VwCxTXSeam8icgos=",
        version = "v1.36.26",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3ZvhNyfmxsAqltQrApLPQMhSFNA+aT87RqyCq4OXmf0=",
        version = "v1.4.21",
    )
    go_repository(
        ...
        sum = "h1:WuUcqi6oYMu/noNTz92QrF1DaFj4eXbhQ6dzaaAwOiI=",
        version = "v2.0.4",
    )
    go_repository(
        ...
        sum = "h1:KZrwa2ciL9od8+TUVJiYTNsCW9J5lktBjGwW1MacEnQ=",
        version = "v2.0.15",
    )
    go_repository(
        ...
        sum = "h1:fk5hTdyLO3KURQsf/+RjMpEm4NE3yeTY9Kh97b5BvwA=",
        version = "v0.0.9",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:O4vvVqr4DGX63vzmO6Fw9vpy3lfztVWHGCQfyw0ZLSY=",
        version = "v0.0.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:1zvwBbyd0TeEuuWftrd/4d++m+/kZSeiguxU61LFWpo=",
        version = "v1.2.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:UCnj7MsobLKLuP/Hh+JMiI/6W5Bs/VF45lWKgHFjSIE=",
        version = "v1.7.11",
    )
    go_repository(
        ...
        sum = "h1:2Kf+dgrzJflNCSw3TV5v2VLeI0s/qkzy2r5jlR0wzf8=",
        version = "v3.0.4",
    )
    go_repository(
        ...
        sum = "h1:kgfh65ob3EcnFYA4kUBvU/menCp9u7qaJLXwWgpobzs=",
        version = "v2.0.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:WYEjhloRHt1R86LhUKjC5y+P52Y11/QqEUalvtzVoys=",
        version = "v0.12.2",
    )
    go_repository(
        ...
        sum = "h1:iwMHqDfPEDEOFzwWKT56eFmh6DYC6o/+xnLAEzgISbA=",
        version = "v2.0.5",
    )
    go_repository(
        ...
        sum = "h1:uGxQsNyrqG3GLINv36Ff60covYmfrLoxzwnCsIYspXI=",
        version = "v0.1.0",
    )
    go_repository(
        ...
        sum = "h1:utennp7RwX+2mtyMzoOXE03IUIckiHBigjarRJZ2DqY=",
        version = "v3.0.5",
    )
    go_repository(
